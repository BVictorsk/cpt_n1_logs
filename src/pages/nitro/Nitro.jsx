      ...
      <CardsContainer>
        <CardNitro>
          ...
          <ul>
            ...
            <li>
              <LiBorder/>
              <StyledNavLink to='/Nitro/criacao/Estagiario'>
