  ...
  return (
    <CreationContainer>
      ...
      <ProcedureContainer>
        ...
        <p>Insira a senha de acesso composta por 8 Caracteres, confirme e vá para a próxima tela. 
A opção marcada é para que o usuário altere a senha no primeiro login, deixe-a selecionada.</p>

        <div className="img-container5">
          <img src={imagenitro5} alt="nitroimg5" />
        </div>

        <p><strong>6°</strong> Criado o usuário, edite as informações na guia Geral (General), edite descrição e Site conforme tela abaixo, (você deve receber essas informações no formulário). </p>
...
Departamento” no chamado. </p>
        ...
        <p>Esse Script Logon , nós criaremos a seguir, ele vai mapear as pastas de rede do usuário, e 
aplicar o papel de parede sempre que ele logar em algum computador na rede.</p>

        <p><strong>Importante “Nunca adicione essa informação no Caminho do perfil (Profile path)”</strong>Isso fará com que o usuário sempre utilize perfis temporários na estação de trabalho.</p>
        ...
        <p>No menu lateral esquerdo da ferramenta, desça alguns níveis até encontrar a opção <strong>Mailbox</strong>. Clique com o botão direito do mouse em <strong>Mailbox</strong> e, em seguida, clique em <strong>New Mailbox</strong>... conforme imagem abaixo.</p>
        ...
        <p>Em seguida, marque a opção <strong>Existing users</strong>: e clique em <strong>Add</strong>.... Abrirá uma nova janela, pesquise pelo nome do colaborador e selecione-o na lista. Em seguida, clique em OK para salvar e fechar a janela atual. Voltando à janela anterior, o nome do colaborador aparecerá na lista. Clique em "Next" para prosseguir.</p>
        
        <div className="img-container13">
          <img src={imagenitro15} alt="nitroimg13" />
        </div>

        <p>Na próxima tela, será preciso informar o <strong>Alias</strong> e especificar a base de dados na qual o usuário será inserido. O Alias e a base de dados devem seguir o padrão informado abaixo de acordo com o tipo de usuário</p>
        ...
        <p>Após preencher o alias, habilite a opção <strong>Specify the mailbox database</strong>, clique em <strong>Browse</strong>... e selecione a base de dados correspondente ao tipo de usuário conforme informações abaixo.</p>
        ...
        <p>Todos e-mails criados no Exchange vêm com o SMTP <strong>@nitro.com.br</strong> configurado por padrão, então para os funcionários da unidade <strong>Nitro - Patos de Minas</strong> devemos realizar a alteração através do procedimento abaixo.</p>
        ...
        <p>Agora é necessário validar se o e-mail foi replicado no Active Directory, então volte na ferramenta e confirme se a informação foi replicada, caso o E-mail não atualize, devemos digitá-lo manualmente:</p>

        
        <div className="img-container13">
          <img src={imagenitro22} alt="nitroimg13" />
        </div>
